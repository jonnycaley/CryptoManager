...
data class Transaction(var exchange : String, var symbol : String, var pairSymbol : String?, var quantity : BigDecimal, var price : BigDecimal, var priceUSD : BigDecimal, var date : Date, var notes : String?, var isDeducted : Boolean, var isDeductedPriceUsd : BigDecimal, var baseImageUrl : String?, var pairImageUrl : String?, var btcPrice: BigDecimal, var ethPrice : BigDecimal) : Serializable
