...
data class Transaction(var exchange : String, var symbol : String, var pairSymbol : String?, var quantity : Float, var price : Float, var priceUSD : Double, var date : Date, var notes : String?, var isDeducted : Boolean, var isDeductedPrice : Double, var baseImageUrl : String?, var pairImageUrl : String?) : Serializable
