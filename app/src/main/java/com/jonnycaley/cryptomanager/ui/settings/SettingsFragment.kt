...
class SettingsFragment : androidx.fragment.app.Fragment(), SettingsContract.View, TabInterface {
    ...
    */
    override fun loadSettings(baseFiat: Rate) {
        ...
        val settingsListAbout: ArrayList<String> = ArrayList(Arrays.asList(resources.getString(R.string.settings_review_app), resources.getString(R.string.settings_share_app), resources.getString(R.string.settings_send_feedback) ,resources.getString(R.string.settings_predictor) , resources.getString(R.string.settings_version)))
