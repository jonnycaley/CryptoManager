...
class PairAdapter(var pairs: List<String>?, var baseSymbol: String, var view: PickerPairContract.View?, var context: Context?) : androidx.recyclerview.widget.RecyclerView.Adapter<PairAdapter.ViewHolder>() {
